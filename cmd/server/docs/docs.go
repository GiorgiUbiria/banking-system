...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.ReconcileResponse"
                        }
                    },
                    "401": {
                        "description": "unauthorized",
    ...
    "definitions": {
        ...
        "internal_handlers.ReconcileEntry": {
            "type": "object",
            "properties": {
                "account_id": {
                    "type": "integer"
        ...
        "internal_handlers.ReconcileResponse": {
            "type": "object",
            "properties": {
                "accounts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_handlers.ReconcileEntry"
                    }
                },
                "all_match": {
                    "type": "boolean"
